...
class InformationRequestSource(str, Enum):
    INTERNAL = "internal"  # Some subsystem or tool added this request.
    TEAM = "team"
...
class NewInformationRequest(BaseModel):
    """
    Represents a new information request to be created.
    This is used to capture requests for additional information.
    """
